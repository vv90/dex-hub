...
use alloy::{
    ...
    providers::{Provider, ProviderBuilder, WsConnect, fillers::RecommendedFillers},
    sol_types::SolCall,
};
...
pub async fn init_client<B>() -> Result<RpcClient<B, impl Provider<B>>>
where
